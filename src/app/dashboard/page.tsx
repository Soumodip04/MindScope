...
// Student Modal Components for Interactive Features
import AITherapySessionModal from '@/components/modals/AITherapySessionModal';
import WellnessTrackingModal from '@/components/modals/WellnessTrackingModal'; // Live Chat Support Widget Component
  ...
  return (
    <div className="p-8 space-y-12">
      ...
      <div className="text-center">
        ...
        <h3 className={`text-2xl font-semibold mb-6 ${isDarkMode ? 'bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent' : 'bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent'}`}>
          Global Mental Health In Your Language
        </h3>
        <p className={`text-lg max-w-4xl mx-auto leading-relaxed ${isDarkMode ? 'text-gray-200' : 'text-gray-600'}`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className={`backdrop-blur-sm rounded-2xl p-6 border ${
          isDarkMode 
            ? 'bg-gradient-to-br from-purple-700/40 to-blue-700/40 border-purple-400/60' 
          ...
          <h3 className={`text-xl font-bold mb-3 ${isDarkMode ? 'text-gray-100' : 'text-gray-800'}`}>AI Therapy Assistant</h3>
          <p className={`leading-relaxed ${isDarkMode ? 'text-gray-200' : 'text-gray-600'}`}>Advanced conversational AI providing evidence-based therapeutic support with CBT and DBT techniques tailored to your needs.</p>
        </div>
        
        <div className={`backdrop-blur-sm rounded-2xl p-6 border ${
          isDarkMode 
            ? 'bg-gradient-to-br from-pink-700/40 to-rose-700/40 border-pink-400/60' 
          ...
          <h3 className={`text-xl font-bold mb-3 ${isDarkMode ? 'text-gray-100' : 'text-gray-800'}`}>Crisis Support & Safety</h3>
          <p className={`leading-relaxed ${isDarkMode ? 'text-gray-200' : 'text-gray-600'}`}>24/7 crisis intervention with immediate access to emergency resources, safety planning, and seamless handoff to human counselors.</p>
        </div>
        
        <div className={`backdrop-blur-sm rounded-2xl p-6 border ${
          isDarkMode 
            ? 'bg-gradient-to-br from-green-700/40 to-emerald-700/40 border-green-400/60' 
          ...
          <h3 className={`text-xl font-bold mb-3 ${isDarkMode ? 'text-gray-100' : 'text-gray-800'}`}>Personalized Therapy Plans</h3>
          <p className={`leading-relaxed ${isDarkMode ? 'text-gray-200' : 'text-gray-600'}`}>Adaptive therapeutic interventions that respond intelligently to your progress, goals, and individual mental health journey.</p>
        </div>
      </div>

      {/* How It Works Section */}
      <div className="text-center">
        <h3 className={`text-2xl font-bold mb-8 ${isDarkMode ? 'text-gray-100' : 'text-gray-800'}`}>How It Works</h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="text-center">
            <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-4">
              <Camera className="w-8 h-8 text-white" />
            </div>
            <h4 className={`font-bold mb-2 ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>Start Conversation</h4>
            <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Begin your therapy session with secure chat</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h4 className={`font-bold mb-2 ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>AI Assessment</h4>
            <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>AI evaluates your needs and emotional state</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h4 className={`font-bold mb-2 ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>Therapeutic Guidance</h4>
            <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>CBT/DBT techniques delivered in real-time</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h4 className={`font-bold mb-2 ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>Personalized Support</h4>
            <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Tailored therapy plans and progress tracking</p>
          </div>
        </div>
      </div>

      {/* Start AI Therapy Button */}
      <div className="text-center">
        <motion.button
...
const WellnessAssessment = ({ userStats, isDarkMode }: { userStats: any; isDarkMode: boolean }) => {
  ...
  const assessments = [
    {
      ...
      component: null // Will be set dynamically in renderAssessmentContent
    },
    {
      id: 'ai-therapist',
      title: 'AI Therapist',
      ...
      component: <AITherapistSuite isDarkMode={isDarkMode} />
    },
    {
      id: 'chat-support',
  ...
  const renderAssessmentContent = () => {
    ...
    // Handle emotion detection component dynamically with current isDarkMode
    if (selectedItem.id === 'emotion') {
      return createEmotionDetectionComponent(isDarkMode);
    }
...
function DashboardContent() {
  ...
  const [showAITherapyModal, setShowAITherapyModal] = useState(false);
  const [showWellnessTrackingModal, setShowWellnessTrackingModal] = useState(false);
          ...
          <div className="space-y-8">
            ...
            >
              {[
                ...
                { id: 'emotions', label: 'Emotion Patterns', icon: Brain },
                { id: 'biometric', label: 'Biometric Health', icon: Heart },
                { id: 'crisis', label: 'Crisis Prevention', icon: Shield },
            ...
            >
              {analyticsTab === 'overview' && (
                <SuspenseWrapper 
                  isDarkMode={isDarkMode}
                  loadingMessage="Loading analytics overview..."
                  showProgress={true}
                >
                  <AnalyticsDashboardHub />
                </SuspenseWrapper>
              )}
              {analyticsTab === 'emotions' && (
                <SuspenseWrapper 
                  isDarkMode={isDarkMode}
                  loadingMessage="Loading emotion analysis..."
                  showProgress={true}
                >
                  <EmotionPatternAnalysis />
                </SuspenseWrapper>
              )}
              {analyticsTab === 'biometric' && (
                <SuspenseWrapper 
                  isDarkMode={isDarkMode}
                  loadingMessage="Loading biometric data..."
                  showProgress={true}
                >
              ...
              {analyticsTab === 'crisis' && (
                <SuspenseWrapper 
                  isDarkMode={isDarkMode}
                  loadingMessage="Loading crisis prevention..."
                  showProgress={true}
                >
              ...
              {analyticsTab === 'journal' && (
                <SuspenseWrapper 
                  isDarkMode={isDarkMode}
                  loadingMessage="Loading AI journal..."
                  showProgress={true}
                >
                  <AITherapyJournal />
                </SuspenseWrapper>
        ...
        return (
          <div className="space-y-8">
            ...
            <div className="text-center space-y-4 mb-8">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Interactive AI therapy sessions, wellness tracking, and personalized mental health support for students
              </p>
            </div>

            {/* Student Interactive Features */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {/* AI Therapy Session Card */}
              <motion.div
                initial={{ opacity: 0, x: -20 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ delay: 0.2 }}
                className={`relative overflow-hidden p-8 rounded-3xl border backdrop-blur-md transition-all duration-300 hover:scale-105 ${
                  isDarkMode 
                    ? 'bg-gradient-to-br from-slate-800/90 via-purple-900/30 to-slate-800/90 border-slate-700/50 hover:border-purple-500/50' 
                    : 'bg-gradient-to-br from-white/95 via-purple-50/80 to-white/95 border-purple-200/50 hover:border-purple-400/50'
                ...
                <div className="relative z-10 space-y-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                        Start an interactive conversation with your AI therapist
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className={`w-full h-2 rounded-full ${isDarkMode ? 'bg-slate-700' : 'bg-gray-200'}`}>
                      <div className="w-3/8 h-2 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full" />
                    </div>
                  </div>
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    onClick={() => setShowAITherapyModal(true)}
                    className="w-full py-4 bg-gradient-to-r from-purple-500 to-blue-600 text-white font-semibold rounded-2xl hover:from-purple-600 hover:to-blue-700 transition-all duration-300 flex items-center justify-center space-x-2"
                  >
                    <MessageSquare className="w-5 h-5" />
                    <span>Start AI Therapy Session</span>
                    <ArrowRight className="w-5 h-5" />
                  </motion.button>
                </div>
              </motion.div>

              {/* Wellness Tracking Card */}
              <motion.div
                initial={{ opacity: 0, x: 20 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ delay: 0.4 }}
                className={`relative overflow-hidden p-8 rounded-3xl border backdrop-blur-md transition-all duration-300 hover:scale-105 ${
                  isDarkMode 
                    ? 'bg-gradient-to-br from-slate-800/90 via-green-900/30 to-slate-800/90 border-slate-700/50 hover:border-green-500/50' 
                    : 'bg-gradient-to-br from-white/95 via-green-50/80 to-white/95 border-green-200/50 hover:border-green-400/50'
                } shadow-xl hover:shadow-2xl`}
              >
                {/* Background Pattern */}
                <div className="absolute inset-0 opacity-10">
                  <div className="absolute inset-0 bg-gradient-to-r from-green-500 to-cyan-500 animate-pulse" />
                </div>

                <div className="relative z-10 space-y-6">
                  <div className="flex items-center space-x-4">
                    <div className="p-3 bg-gradient-to-r from-green-500 to-cyan-600 rounded-2xl">
                    ...
                    <div>
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                        Monitor your daily wellness and set goals
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className={`w-full h-2 rounded-full ${isDarkMode ? 'bg-slate-700' : 'bg-gray-200'}`}>
                      <div className="w-4/5 h-2 bg-gradient-to-r from-green-500 to-cyan-500 rounded-full" />
                    </div>
                  </div>

                  <div className="grid grid-cols-3 gap-4">
                    {[
                      { label: 'Mood', value: '8.5', icon: '😊' },
                      { label: 'Sleep', value: '7.8', icon: '😴' },
                      { label: 'Energy', value: '8.3', icon: '⚡' }
                    ].map((stat, index) => (
                      <div key={index} className={`text-center p-3 rounded-xl ${
                        isDarkMode ? 'bg-slate-700/50' : 'bg-white/60'
                      }`}>
                  ...
                  <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    onClick={() => setShowWellnessTrackingModal(true)}
                    className="w-full py-4 bg-gradient-to-r from-green-500 to-cyan-600 text-white font-semibold rounded-2xl hover:from-green-600 hover:to-cyan-700 transition-all duration-300 flex items-center justify-center space-x-2"
                  >
            ...
            >
              {[
                { icon: Wind, label: 'Breathing Exercise', color: 'from-blue-500 to-cyan-500' },
                { icon: TreePine, label: 'Meditation', color: 'from-green-500 to-teal-500' },
                { icon: Trophy, label: 'Goals & Achievements', color: 'from-yellow-500 to-orange-500' },
                { icon: Eye, label: 'Mindfulness', color: 'from-purple-500 to-pink-500' }
              ].map((action, index) => {
                ...
                return (
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className={`p-6 rounded-2xl bg-gradient-to-r ${action.color} text-white shadow-lg hover:shadow-xl transition-all duration-300`}
                  >
  ...
  return (
    ...
    >
      <div className={`min-h-screen transition-colors duration-500 ${
        ...
        {showAITherapyModal && (
          <AITherapySessionModal
            isOpen={showAITherapyModal}
            onClose={() => setShowAITherapyModal(false)}
          />
        )}
        {showWellnessTrackingModal && (
          <WellnessTrackingModal
            isOpen={showWellnessTrackingModal}
            onClose={() => setShowWellnessTrackingModal(false)}
          />
        )}
      </div>
    </EnhancedErrorBoundary>
